module.exports = {
    name: "kızrol",
    code: `$setServerVar[kadınrol;$findRole[$message[1]]
    $description[Kadın Rolü  <@&$findRole[$message[1]]> Olarak Ayarlandı!]
...
{field:**Lütfen Şu Biçimde Kullanınız**:\`$getServerVar[prefix]kadınrol <rol | rolID>\`}{color:RED}]
